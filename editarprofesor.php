...
<body>
   <center>
  <form id="form1" name="form1" method="post" action="guardaredicionprofesor.php">  
  <strong><h3>EDITAR PROFESOR</h3></strong>
  ...
  <td><span id="sprytextfield2">
  <input name="direccion" class="caja" value="<?php echo $direccion;?>" onkeypress="return soloLetras(event)" type="text" id="direccion" size="28" autocomplete="off">
  <span class="textfieldRequiredMsg"><img src="imagenes/error.gif" title="CAMPO VACIO"></span></span></td>
  </tr>
  <tr>
  <td align="right">Telefono:</td>
  <td><span id="sprytextfield2">
  <input name="telefono" class="caja" value="<?php echo $telefono;?>" onkeypress="return soloLetras(event)" type="text" id="telefono" size="28" autocomplete="off">
  <span class="textfieldRequiredMsg"><img src="imagenes/error.gif" title="CAMPO VACIO"></span></span></td>
  </tr>
