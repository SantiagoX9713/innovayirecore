    ...
    <form id="form1" name="form1" method="post" action="nuevopedido.php">  
      ...
      <table width="68%" border="0" align="center" class="down1">
        <tbody>
          ...
          <tr>
            <td align="right">Bordado:</td>
            <td><span id="sprytextfield3">
            <input name="fechaDeEntrega" class="caja"  type="checkbox" id="fechaDeEntrega"  autocomplete="off">
            <span class="textfieldRequiredMsg"><img src="imagenes/error.gif" title="CAMPO VACIO"></span></span></td>
          </tr>

          <tr>
            <td align="right">Serigrafía:</td>
          ...
          <tr>
            <td colspan="2">
              <input type="submit" class="boot" name="botonDeAccion" value="GUARDAR">
            </td>
          </tr>
        </tbody>
      </table>
