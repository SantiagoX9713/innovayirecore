...
<body>
  ...
  <strong><h3>REGISTRAR CALIFIACION</h3></strong>
  <table width="68%" border="0" align="center" class="down1">
  
  <tbody>
  
  <tr>
  <td align="right">Calificacion:</td>
  ...
  <tr>
  <td align="right">Exelente:</td>
  <td><span id="sprytextfield3">
  <input name="exelente" class="caja" onkeypress="return soloLetras(event)" type="text" id="exelente" size="28" autocomplete="off">
  <span class="textfieldRequiredMsg"><img src="imagenes/error.gif" title="CAMPO VACIO"></span></span></td>
  </tr> 
